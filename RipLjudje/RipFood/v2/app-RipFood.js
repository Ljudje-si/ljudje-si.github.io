...
const Traffic_jam = { title: "Traffic Jam", desc: "“Everyone is an idiot and doesn’t know how to drive.”", background: "gradient (5).gif" }
...
const Clean_House = { title: "Clean House", desc: "A clean home carries a strong aura of perfection, an ambiance of clarity, and a sense of wholesomeness. Truth be told, everyone loves to walk into a clean home, but not everyone has the will to maintain a clean house. If you have ever had a clean home, you must have had at least one of these unique feelings.", background: "gradient (7).gif" }
const New_Haircut = { title: "New Haircut", desc: "Many people carry tension in their neck, head, and shoulders, and the motion of the scalp massage helps relax these muscles. It also causes the body to release endorphins and serotonin, which are natural “feel-good” chemicals that help create a sense of calm.", background: "gradient (8).gif" }
const Fresh_Sheets = { title: "Fresh Sheets", desc: "There’s something about being in a fresh environment that gives you peace of mind. It’s similar to the feeling you get when you walk into an organized room versus a cluttered space, but the effects are magnified because the sheets also touch your skin, employing another one of your senses.", background: "gradient (9).gif" }
...
const Forest_Walk = { title: "Forest Walk", desc: "It may even feel like you’re breathing for the first time in your life. The air in the forest smells good. It may smell like damp moss, rain, wet tree trunks, flowers, and a needle-covered path. It may smell like a tree stump that is already creating new life, or even snow, frost, and softwood.", background: "gradient (14).gif" }
const Inside_Jokes = { title: "Inside Jokes", desc: "The funniest jokes—the ones I laugh at the hardest for the longest—are the inside jokes with my friends. Because we know each other so well, those jokes are unique to just us. They come from a shared understanding that only we get.", background: "gradient (15).gif" }
...
const Free_Samples = { title: "Free Samples", desc: "It is only worth it because it’s free.", background: "gradient (18).gif" }
const First_Kiss = { title: "First Kiss", desc: "Chances are, your first kiss will be gentle and sweet. It may be that you and your partner are both new to the kissing scene, so they may not know what to do either. Although the experience may not be that long, the tender feeling of the person’s lips will stay with you for a very long time.", background: "gradient (19).gif" }
const Break_up = { title: "Break-up", desc: "After a break-up, many people experience a range of complicated feelings, like sadness, anger, or guilt, which may lead to feeling rejected, confused, or lonely. You might even feel relief which can be just as confusing. Some people feel that their world has turned upside down and that things will never be good again.", background: "gradient (20).gif" }
...
const Losing_Your_Job = { title: "Losing Your Job", desc: "Aside from the apparent financial anguish, it can cause, the stress of losing a job can also take a heavy toll on your mood, relationships, and overall mental and emotional health. Suddenly finding yourself out of work can leave you feeling hurt, angry, or depressed.", background: "gradient (22).gif" }
const Snow_Day = { title: "Day off", desc: "Getting the right amount of shuteye (seven to nine hours for most people) can, among its plethora of benefits, make us less stressed, help maintain a healthy metabolism, ward off Alzheimer’s disease, make us happier, and boost immunity.", background: "gradient (23).gif" }
const Friday_Hungover = { title: "Friday Hungover", desc: "Sit in the shower. Wear soft clothes. Drink every liquid imaginable, then, when you feel you’ve maxed your quota of liquids, drink at least three more. Change your email background to grayscale. Have an anti-spiraling mantra. Throw up before going to work.", background: "gradient (24).gif" }
...
const Friend_Of_The_Animals = { title: "Friend Of Animals", desc: "Ostriches are attracted to humans. They will commonly perform mating dances for humans and prefer to try and impress humans rather than other ostriches. Elephants also show signs of thinking that animals are adorable by petting them with their trunk.", background: "gradient (27).gif" }
