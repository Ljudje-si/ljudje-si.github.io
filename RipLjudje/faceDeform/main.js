...
function init_faceFilter(videoSettings){
  JEELIZFACEFILTER.init({
    canvasId: 'jeeFaceFilterCanvas',
    NNCPath: '../jeelizFaceFilter_code/neuralNets/', // root of NN_DEFAULT.json file
