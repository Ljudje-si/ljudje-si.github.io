...
function setup() {
  ...
  overlay.setAttribute("style", "background-color: red; width: 100%; height: 100%; position: absolute; top: 0; left: 0; mix-blend-mode: multiply; z-index: 1;")
  document.getElementById('canvas_div').appendChild(overlay);
  ...
  setTimeout(function () {
    ...
    setTimeout(function () {
      noLoop()
      document.getElementById("save_x").style.display = "block"
      document.getElementById("save_x").addEventListener('click', function () {
        saveXCanvas()
      })
...
var drawing_tools = [
  "triReset", "fixX", "changeX", "changeXDraw", "x_curved", "scatter", "xline", "vhlines", "line", "line_curved", "circle", "square", "square_round", "rectangle", "rectangle_round", "triangle",
  "triReset", "fixX", "changeX", "changeXDraw", "x_curved", "scatter", "xline", "vhlines", "line", "line_curved", "circle", "square", "square_round", "rectangle", "rectangle_round", "triangle",
  "triReset", "fixX", "changeX", "changeXDraw", "x_curved", "xline", "vhlines", "line", "line_curved", "circle", "square", "square_round", "rectangle", "rectangle_round", "triangle"]
