...
function draw() {
  ...
  var colorTrans = random(100, 255)
  var R = color(255, 0, 0, colorTrans)
  var Y = color(255, 255, 0, colorTrans)
  var B = color(0, 0, 255, colorTrans)
  var RYBcolors = [R, Y, B]
  ...
  if (drawing_option == "circle") {
    noStroke()
    fill(RYBcolors[Math.floor(Math.random() * RYBcolors.length)])
